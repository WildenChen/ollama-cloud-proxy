...
const dictionaries = {
  "zh-Hant": {
    ...
    availableKeysMetric: "可用上游金鑰",
    weeklyResetMetric: "每週重置",
    sessionResetMetric: "5hr 重置",
    upstreamRequests: "上游請求",
    addKey: "新增上游金鑰",
    addKeyTitle: "新增一把 Ollama Cloud 上游 API 金鑰",
    addKeyAria: "新增 Ollama Cloud 上游金鑰",
    eventsTitle: "事件",
    ...
    keySettingsTitle: "上游金鑰設定",
    closeKeySettingsTitle: "關閉上游金鑰設定",
    saveKeySettings: "儲存設定",
    keySettingsSaved: "上游金鑰設定已儲存。",
    ...
    dialogTitle: "新增 Ollama Cloud 上游金鑰",
    closeDialogTitle: "關閉新增金鑰視窗",
    nameLabel: "名稱",
    apiKeyLabel: "Ollama Cloud API 金鑰",
    ...
    noKeys: "目前沒有上游金鑰。請新增第一把已加密保存的 Ollama Cloud API 金鑰。",
    noEvents: "目前沒有近期事件。",
  ...
  en: {
    ...
    availableKeysMetric: "Available upstream keys",
    weeklyResetMetric: "Weekly reset",
    sessionResetMetric: "5hr reset",
    upstreamRequests: "Upstream requests",
    addKey: "Add Upstream Key",
    addKeyTitle: "Add an Ollama Cloud upstream API key",
    addKeyAria: "Add Ollama Cloud upstream key",
    eventsTitle: "Events",
    ...
    keySettingsTitle: "Upstream Key Settings",
    closeKeySettingsTitle: "Close upstream key settings",
    saveKeySettings: "Save Settings",
    keySettingsSaved: "Upstream key settings saved.",
    ...
    dialogTitle: "Add Ollama Cloud Upstream Key",
    ...
    noKeys: "No upstream keys yet. Add the first encrypted Ollama Cloud API key.",
    ...
    action: {
      ...
      "key-settings": "Upstream Key Settings",
